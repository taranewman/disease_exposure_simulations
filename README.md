...
For example to access the control scenario (no public health measures) for scenario 1, in Vadere open the Scenario1/base:Control_scenario/ folder and open the vadere.project file. 
